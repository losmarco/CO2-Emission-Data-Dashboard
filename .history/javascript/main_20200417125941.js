...
d3.csv("data/co2-emission-1970-2012new.csv")
    .then(function(csvdata){
        ...
        //world co2 data from 1970-2012(for y axis)
        const worldCarbonString = Object.values(csvdata[217]).splice(2,43);
        const worldCarbonNum = parseFloat(worldCarbonString);
        console.log(worldCarbonNum);
    // Add X axis 
    var x = d3.scaleTime()
   ...
   var bigdata = [year, worldCarbonNum];
   console.log(bigdata);

    var line = d3.line()
                 .x((d)=>{return x(d.year)})
                 .y((d)=>{return y(d.worldCarbon)});
