...
d3.csv("data/co2-emission-1970-2012new.csv")
  .then(function(csvdata){
    ...
    var treeColorScale = d3.scaleOrdinal()
    .domain(d3.extent(d3.selectAll('rect.child').data(), function(d) { return d.value; }))
    ...
    cell.append("rect")
        ...
        .style("fill", function(d) { return treeColorScale(d.value)});
