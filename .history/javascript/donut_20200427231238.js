...
.domain(["Agriculture", 
        ...
        "Residential",
        "Transport"])
.range(["#ffa600", "#ff7c43", "#f95d6a", "#d45087", "#a05195", "#665191", "#2f4b7c"]);
...
d3.csv("data/world-sector.csv")
  ...
  const total = (agri + cap + eahp + industry + oei + residential + transport);
  ...
  //Tooltip
  var donutTooltip = d3.select("#donut")
                      .append("div")
                      .style("opacity", 0)
                      .attr("class", "tooltip");
                      donutTooltip.html(data)
                      .style("left", (d3.event.pageX + 10) + "px")
                      .style("top", (d3.event.pageY - 15) + "px");
  // donutTooltip.html(d.data.key)
  //             .style("left", (d3.event.pageX + 10) + "px")
  //             .style("top", (d3.event.pageY - 15) + "px");
  ...
  donutSvg.selectAll('allSlices')
      ...
      .append('path')
      .attr('d', arc)
      .attr('fill', function(d,i){ return(donutColor(d.data.key)) })
      .attr("stroke", "white")
  ...
  legend.append('text')
        ...
        .attr('y', legendRectSize - legendSpacing  + 4.6)
